...
2. **Case Files**: Each news article becomes a case file, complete with a brief, eye-catching headline and a "difficulty rating".

3. **Investigation Process**:
   - Read the article summary (case briefing)
   - Gather evidence (answer questions about the article) 
   - Connect the dots/write up case report (final summary question or task)
...
7. **Multiplayer Elements**:
   - Form detective teams to solve complex cases
   - Agency vs Agency competitions
   - Global leaderboards
